#!/bin/bash
#SBATCH --job-name=prep_tissue_g1
...
run_one configs/preprocessing_sthelar40x_liver_5class_spatial_margin128.yaml
run_one configs/preprocessing_sthelar40x_kidney_5class_spatial_margin128.yaml
run_one configs/preprocessing_sthelar40x_tonsil_5class_spatial_margin128.yaml

echo "===== GROUP 1 PREPROCESSING DONE ====="
