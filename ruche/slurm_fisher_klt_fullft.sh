#!/bin/bash
#SBATCH --job-name=fisher_klt_fullft
...
CONFIG="configs/examples/training_sthelar40x_kidney_liver_tonsil_5class_spatial_margin128_fullft_lr1e-5_e10_seed42_CLEAN.yaml"
RUN_LOG_ROOT="run/sthelar40x_kidney_liver_tonsil_5class_spatial_margin128_fullft_lr1e-5_e10_seed42_CLEAN/log"
OUTPUT_DIR="reports/fisher_drift/klt_fullft_blocks_b${NUM_BATCHES}"
