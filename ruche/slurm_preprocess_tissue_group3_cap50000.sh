#!/bin/bash
#SBATCH --job-name=prep_g3_cap50k
...
run_one configs/preprocessing_sthelar40x_colon_5class_spatial_margin128_cap50000.yaml
run_one configs/preprocessing_sthelar40x_lung_5class_spatial_margin128_cap50000.yaml
run_one configs/preprocessing_sthelar40x_skin_5class_spatial_margin128_cap50000.yaml

echo "===== GROUP 3 CAPPED PREPROCESSING DONE ====="
