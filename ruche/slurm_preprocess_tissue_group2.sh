#!/bin/bash
#SBATCH --job-name=prep_tissue_g2
...
run_one configs/preprocessing_sthelar40x_breast_5class_spatial_margin128.yaml
run_one configs/preprocessing_sthelar40x_colon_5class_spatial_margin128.yaml
run_one configs/preprocessing_sthelar40x_lung_5class_spatial_margin128.yaml

echo "===== GROUP 2 PREPROCESSING DONE ====="
